  ...
  if (isBlankTab) {
    (function() {
      ...
      var album1 = document.getElementById('album1'),
          album2 = document.getElementById('album2'),
          album3 = document.getElementById('album3'),
          album4 = document.getElementById('album4'),
          album5 = document.getElementById('album5'),
          album6 = document.getElementById('album6'),
          album7 = document.getElementById('album7'),
          album8 = document.getElementById('album8'),
          album9 = document.getElementById('album9'),
          album10 = document.getElementById('album10'),
          album11 = document.getElementById('album11'),
          album12 = document.getElementById('album12'),
          album13 = document.getElementById('album13'),
          album14 = document.getElementById('album14'),
          album15 = document.getElementById('album15'),
          album16 = document.getElementById('album16'),
      ...
      var init = {
        ...
        start: function(id) {
          ...
          this.displayPrefsLink();
            ...
            user_data = 1004;
            add.box({ width: 3.77, height: 3.77, img_src: 1004 });
            user_data = 1005;
            add.box({ width: 4.72, height: 4.72, img_src: 1005 });
            user_data = 1006;
            add.box({ width: 4.91, height: 4.91, img_src: 1006 });
            user_data = 1007;
            add.box({ width: 5.88, height: 5.88, img_src: 1007 });
            user_data = 1008;
            add.box({ width: 5.37, height: 5.37, img_src: 1008 });
            user_data = 1009;
            add.box({ width: 4.88, height: 4.88, img_src: 1009 });
            user_data = 1010;
            add.box({ width: 6.0, height: 6.0, img_src: 1010 });
            user_data = 1011;
            add.box({ width: 5.28, height: 5.28, img_src: 1011 });
            user_data = 1012;
            add.box({ width: 5.02, height: 5.02, img_src: 1012 });
            user_data = 1013;
            add.box({ width: 4.44, height: 4.44, img_src: 1013 });
            user_data = 1014;
            add.box({ width: 4.2, height: 4.2, img_src: 1014 });
            user_data = 1015;
            add.box({ width: 4.72, height: 4.72, img_src: 1015 });
            user_data = 1016; //witness
            add.box({ width: 3.69, height: 3.69, img_src: 1016 });
            user_data = 1017; //albumized logo
            add.box({ width: 1.4, height: 1.6, img_src: 1017 });
        ...
        itunesLookup: function(specialday) {
            ...
            $.getJSON('https://itunes.apple.com/search?media=music&entity=album&attribute=songTerm&limit=16&term='+encodeURIComponent(randomTerm), function(data) {
              $.each(data, function() {
                $.each(this, function(s, song) {
                  ...
                  //this['albumLink'+s] = init.getLocalizedLink(albumUrl);
                  switch(s) {
                    case 0:
      ...
      var Box = function(options) {
          ...
          this.draw = function() {
            ...
            switch(this.img_src) {
              case 1001: img = album1; break;
              case 1002: img = album2; break;
              case 1003: img = album3; break;
              case 1004: img = album4; break;
              case 1005: img = album5; break;
              case 1006: img = album6; break;
              case 1007: img = album7; break;
              case 1008: img = album8; break;
              case 1009: img = album9; break;
              case 1010: img = album10; break;
              case 1011: img = album11; break;
              case 1012: img = album12; break;
              case 1013: img = album13; break;
              case 1014: img = album14; break;
              case 1015: img = album15; break;
              case 1016: img = album16; break;
              default:   img = img_fro; break;
            }
            ctx.drawImage(img,
              (this.x-(this.width / 2)) * SCALE,
              (this.y-(this.height / 2)) * SCALE,
      ...
      canvasID.addEventListener('mousedown', function(e) {
        ...
        if (selectedBody !== null) {
          ...
          switch(selectedBody.BoxNumber) {
            case 1001: window.open(albumLink1, '_blank'); break;
            case 1002: window.open(albumLink2, '_blank'); break;
            case 1003: window.open(albumLink3, '_blank'); break;
            case 1004: window.open(albumLink4, '_blank'); break;
            case 1005: window.open(albumLink5, '_blank'); break;
            case 1006: window.open(albumLink6, '_blank'); break;
            case 1007: window.open(albumLink7, '_blank'); break;
            case 1008: window.open(albumLink8, '_blank'); break;
            case 1009: window.open(albumLink9, '_blank'); break;
            case 1010: window.open(albumLink10, '_blank'); break;
            case 1011: window.open(albumLink11, '_blank'); break;
            case 1012: window.open(albumLink12, '_blank'); break;
            case 1013: window.open(albumLink13, '_blank'); break;
            case 1014: window.open(albumLink14, '_blank'); break;
            case 1015: window.open(albumLink15, '_blank'); break;
            case 1016: window.open(albumLink16, '_blank'); break;
            default: break;
          }
